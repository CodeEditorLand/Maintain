//=============================================================================//
// File Path: Element/Maintain/Source/Build/Function/FnFunction.rs
//=============================================================================//
// Module: FnFunction
//
...
/// ```rust
/// fn main() {
///     crate::Maintain::Source::Build::Function::FnFunction::Fn();
/// }
/// ```
//
//=============================================================================//
...
use crate::Build::{Definition::Argument, Function::{Logger, Process}};
