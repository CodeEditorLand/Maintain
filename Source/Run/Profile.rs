...
use crate::Run::Constant::ProfileDefault;
use crate::Run::Definition::{Profile, RunProfileConfig};
...
pub fn get_run_config(profile: &Profile) -> RunProfileConfig {
    profile.run_config.clone().unwrap_or_else(|| RunProfileConfig {
        hot_reload: true,
        watch: true,
